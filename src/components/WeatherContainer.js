...
function WeatherContainer() {
    ...
    return <div>
        ...
        <div className='flex flex-col w-auto h-auto pt-10 bg-transparent justify-start items-center'>
            ...
            <img alt="weatherIcon" src="weather.png" className="w-36 h-36"></img> 

            <div className="text-5xl  text-center w-auto h-max text-white">
                <h1 className='mt-5 mb-5'>{context.language ==="tr" ? "Hava Durumu Uygulaması" : "Weather App"}</h1> 
            </div>
            ...
            <div className='mt-5 text-white'>   {/*Şehir Seçme Card*/}
                ...
                <select onChange={cityHandleChange} id="cities " className='text-black border-cyan-300 rounded-xl ml-3 w-auto    h-12 m-3'> {/*Dinamik hale gelecek*/}
